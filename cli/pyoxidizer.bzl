...
def make_exe():
    ...
    # This is required for extension modules that cannot be loaded from memory
    ...
    # Set the entry point to run the main module
    ...
    # Install the nasiko-cli package with all dependencies from pyproject.toml
