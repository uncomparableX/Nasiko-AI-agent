...
class AuthManager:
    ...
    def refresh_token_if_needed(self) -> bool:
        ...
        try:
            ...
            # Try a few common healthcheck paths
            health_paths = ["/api/v1/healthcheck", "/healthcheck", "/health"]
            
            for path in health_paths:
                health_url = f"{base_url_str}{path}"
                try:
            ...
            # If all healthchecks fail, try auto-renewal as a fallback
            return self._auto_renew_token()
